...
11. [QUESTBOOK](QUESTBOOK.md) for bounded infra obligations and closed packet records
...
- **host posture and machine facts**: [reference platform](mechanics/machine-fit/parts/reference-platform/docs/REFERENCE_PLATFORM.md), [reference platform spec](mechanics/machine-fit/parts/reference-platform/docs/REFERENCE_PLATFORM_SPEC.md), [machine bridge](mechanics/machine-fit/parts/machine-bridge/docs/MACHINE_BRIDGE.md), [machine fit policy](mechanics/machine-fit/parts/fit-record/docs/MACHINE_FIT_POLICY.md), [profile machine-fit packet](mechanics/machine-fit/parts/fit-record/docs/PROFILE_MACHINE_FIT_PACKET.md), [platform adaptation policy](mechanics/machine-fit/parts/platform-adaptations/docs/PLATFORM_ADAPTATION_POLICY.md), [machine-fit follow-through packet](mechanics/machine-fit/parts/platform-adaptations/docs/MACHINE_FIT_FOLLOW_THROUGH_PACKET.md)
...
- **runtime-side AoA seams**: [memo runtime seam](mechanics/federation-seams/parts/memo-seam/docs/MEMO_RUNTIME_SEAM.md), [eval runtime seam](mechanics/federation-seams/parts/eval-seam/docs/EVAL_RUNTIME_SEAM.md), [playbook runtime seam](mechanics/federation-seams/parts/playbook-seam/docs/PLAYBOOK_RUNTIME_SEAM.md), [KAG runtime seam](mechanics/federation-seams/parts/kag-seam/docs/KAG_RUNTIME_SEAM.md), [RPG runtime materialization packet](mechanics/federation-seams/parts/rpg-runtime/docs/RPG_RUNTIME_MATERIALIZATION_PACKET.md), [antifragility runtime](mechanics/runtime-repair/parts/antifragility-posture/docs/ANTIFRAGILITY_RUNTIME.md), [runtime repair provenance](mechanics/runtime-repair/PROVENANCE.md), [repair-safe closeout](mechanics/runtime-repair/parts/repair-safe-closeout/docs/REPAIR_SAFE_CLOSEOUT.md), [diagnostic spine](mechanics/diagnostic-spine/parts/diagnostic-surfaces/docs/DIAGNOSTIC_SPINE.md), and [diagnostic runtime packet](mechanics/diagnostic-spine/parts/diagnostic-surfaces/docs/DIAGNOSTIC_RUNTIME_PACKET.md)
...
- **runtime mechanics topology**: [mechanics/README](mechanics/README.md), [source runtime parity packet](mechanics/runtime-lifecycle/parts/config-sync-boundary/docs/SOURCE_RUNTIME_PARITY_PACKET.md), [live runtime cutover packet](mechanics/runtime-lifecycle/parts/start-stop/docs/LIVE_RUNTIME_CUTOVER_PACKET.md), and [docs/MECHANICS](docs/MECHANICS.md)
