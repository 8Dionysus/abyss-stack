...
EXPECTED_ACTIVE_SCHEMA_PATHS = {
    ...
    Path("mcp/protocol-lab/schemas/kag-cache-pair-current-observation.schema.json"),
    ...
    Path("mcp/protocol-lab/schemas/protocol-frozen-conformance-observation.schema.json"),
    ...
    Path("mcp/protocol-lab/schemas/protocol-watch-plan.schema.json"),
    Path("mcp/protocol-lab/schemas/protocol-watch-run-verdict.schema.json"),
    Path("mcp/protocol-lab/schemas/protocol-watch-runtime.schema.json"),
    Path("mcp/protocol-lab/schemas/protocol-watch-status.schema.json"),
    Path("mcp/protocol-lab/schemas/rmcp-tasks-adapter-pair.schema.json"),
    Path("mcp/protocol-lab/schemas/stable-kag-post-rollback-observation.schema.json"),
    Path(
        "mcp/protocol-lab/schemas/stable-kag-post-rollback-current-observation.schema.json"
    ),
    Path("mcp/protocol-lab/schemas/tasks-adapter-pilot.schema.json"),
    Path("mcp/protocol-lab/schemas/tasks-compatibility-matrix.schema.json"),
    Path("mcp/services/abyss-stack-mcp/schemas/admission-automation-status.schema.json"),
    Path("mcp/services/abyss-stack-mcp/schemas/keeper-spec-build.schema.json"),
    Path("mcp/services/abyss-stack-mcp/schemas/managed-contour-topology.schema.json"),
    Path("mcp/services/abyss-stack-mcp/schemas/managed-contours.schema.json"),
    Path("mcp/services/abyss-stack-mcp/schemas/mcp-preflight-report.schema.json"),
    Path("mcp/services/abyss-stack-mcp/schemas/mcp-preflight-sweep.schema.json"),
    Path("mcp/services/abyss-stack-mcp/schemas/mcp-system-status.schema.json"),
    ...
    Path(
        "mechanics/governed-execution/parts/external-codex-agent/schemas/external-codex-continuity-capsule-reinjection.schema.json"
    ),
    Path(
        "mechanics/governed-execution/parts/external-codex-agent/schemas/external-codex-event.schema.json"
    ),
    Path(
        "mechanics/governed-execution/parts/external-codex-agent/schemas/external-codex-governed-landing-effect-grant.schema.json"
    ),
    Path(
        "mechanics/governed-execution/parts/external-codex-agent/schemas/external-codex-workspace-manifest-legacy-evidence.schema.json"
    ),
    Path(
        "mechanics/governed-execution/parts/external-codex-agent/schemas/external-codex-workspace-manifest-legacy-owner-receipt.schema.json"
    ),
    Path(
    ...
    Path(
        "mechanics/governed-execution/parts/external-codex-agent/schemas/external-codex-reentry-state.schema.json"
    ),
    Path(
