...
class AoADiagnoseTests(unittest.TestCase):
    ...
    def setUpClass(cls) -> None:
        ...
        cls.target_validator = Draft202012Validator(load_schema("schemas/diagnostic_target.schema.json"))
        cls.session_validator = Draft202012Validator(load_schema("schemas/diagnostic_session.schema.json"))
        cls.companion_validator = Draft202012Validator(load_schema("schemas/diagnosis_companion.schema.json"))
        cls.anchor_validator = Draft202012Validator(load_schema("schemas/diagnostic_anchor_ref.schema.json"))
        cls.handoff_validator = Draft202012Validator(load_schema("schemas/repair_handoff.schema.json"))
        cls.review_ref_validator = Draft202012Validator(load_schema("schemas/reviewed_diagnosis_ref.schema.json"))
