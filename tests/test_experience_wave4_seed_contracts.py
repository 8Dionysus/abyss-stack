...
WAVE4_CONTRACTS = (
    ('governance_job_record', 'governance_job_record_v1.json'),
    ('governance_storage_record', 'governance_storage_record_v1.json'),
    ('constitution_runtime_storage_record_v1', 'constitution_runtime_storage_record_v1.json'),
)
