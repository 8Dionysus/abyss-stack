...
9. `mechanics/config-projection/docs/RENDER_TRUTH.md`
10. `mechanics/runtime-lifecycle/docs/INTERNAL_PROBES.md`
11. `docs/PATHS.md`
12. `docs/STORAGE_LAYOUT.md`
13. `docs/DEPLOYMENT.md`
14. `docs/FIRST_RUN.md`
15. `mechanics/diagnostic-spine/docs/DOCTOR.md`
16. `mechanics/config-projection/docs/SECRETS_BOOTSTRAP.md`
