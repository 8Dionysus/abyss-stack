...
- `Logs/` — logs and generated runtime artifacts, including local private host-facts captures under `Logs/host-facts/`, memo export candidates under `Logs/memo-exports/`, eval export candidates under `Logs/eval-exports/`, RPG runtime copies under `Logs/rpg/`, platform-adaptation records under `Logs/platform-adaptations/`, and runtime benchmark artifacts under `Logs/runtime-benchmarks/`
