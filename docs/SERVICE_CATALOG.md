...
- `mechanics/diagnostic-spine/docs/LOCAL_OPS_DOCTOR_SPLIT.md` preserves `aoa-doctor` as readiness-only while future local ops readout stays a separate bounded status surface
