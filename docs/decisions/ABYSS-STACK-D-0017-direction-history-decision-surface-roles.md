# Direction, History, And Decision Surface Roles

- Decision ID: ABYSS-STACK-D-0017
- Status: accepted
- Date: 2026-05-14
...
- Surface classes: docs route, authority/boundary
- Stack lanes: docs and routes, decision lane
- Mechanic parents: none
- Guard families: decision index/read-model, docs route
- Posture: accepted route split rationale
