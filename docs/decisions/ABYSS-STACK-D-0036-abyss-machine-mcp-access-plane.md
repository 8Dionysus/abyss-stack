...
- Decision ID: ABYSS-STACK-D-0036
- Status: accepted
- Date: 2026-05-25
...
- Surface classes: MCP access plane, host bridge, machine evidence
- Stack lanes: MCP services, machine fit
- Mechanic parents: machine-fit
- Guard families: read-only access plane, host evidence freshness
- Posture: accepted machine access-plane rationale
