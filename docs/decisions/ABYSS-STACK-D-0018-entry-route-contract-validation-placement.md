# Entry Route Contract And Validation Placement

- Decision ID: ABYSS-STACK-D-0018
- Status: accepted
- Date: 2026-05-14
...
- Surface classes: docs route, validation guard
- Stack lanes: docs and routes
- Mechanic parents: none
- Guard families: docs route, validation lane
- Posture: accepted entry route rationale
