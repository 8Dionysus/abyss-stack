...
- Decision ID: ABYSS-STACK-D-0025
- Status: accepted
- Date: 2026-05-14
...
- Surface classes: runtime profile, validation guard
- Stack lanes: profiles and presets
- Mechanic parents: config-projection
- Guard families: profile composition, validation lane
- Posture: accepted preset composition rationale
