...
- Decision ID: ABYSS-STACK-D-0031
- Status: superseded
- Superseded by: `ABYSS-STACK-D-0032-mcp-services-topology.md`
- Date: 2026-05-20
...
- Surface classes: MCP access plane, legacy/provenance
- Stack lanes: MCP services
- Mechanic parents: none
- Guard families: MCP port confinement, read-only access plane
- Posture: superseded MCP topology rationale
...
`docs/decisions/ABYSS-STACK-D-0032-mcp-services-topology.md`.
