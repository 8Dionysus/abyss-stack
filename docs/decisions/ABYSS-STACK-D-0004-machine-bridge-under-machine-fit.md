# Machine Bridge Under Machine Fit

- Decision ID: ABYSS-STACK-D-0004
- Status: accepted
- Date: 2026-05-12
...
- Surface classes: host bridge, machine evidence, mechanic part
- Stack lanes: machine fit
- Mechanic parents: machine-fit
- Guard families: host evidence freshness, source/runtime boundary
- Posture: accepted host bridge rationale
