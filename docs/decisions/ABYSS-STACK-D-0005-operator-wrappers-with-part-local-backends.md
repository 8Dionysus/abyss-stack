# Operator Wrappers With Part-Local Backends

- Decision ID: ABYSS-STACK-D-0005
- Status: accepted
- Date: 2026-05-12
...
- Surface classes: mechanic part, source/runtime boundary
- Stack lanes: config projection, runtime lifecycle
- Mechanic parents: cross-mechanic
- Guard families: runtime topology, validation lane
- Posture: accepted wrapper topology rationale
