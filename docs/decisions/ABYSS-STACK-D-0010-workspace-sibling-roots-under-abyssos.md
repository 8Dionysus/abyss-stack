# Workspace Sibling Roots Under AbyssOS

- Decision ID: ABYSS-STACK-D-0010
- Status: accepted
- Date: 2026-05-13
...
- Surface classes: authority/boundary, source/runtime boundary
- Stack lanes: source checkout
- Mechanic parents: none
- Guard families: source/runtime boundary
- Posture: accepted workspace boundary rationale
