# Local AI Trials First-Run Boundary

- Decision ID: ABYSS-STACK-D-0006
- Status: accepted
- Date: 2026-05-13
...
- Surface classes: source/runtime boundary, mechanic part
- Stack lanes: inference pilots
- Mechanic parents: inference-pilots
- Guard families: source/runtime boundary, service selection
- Posture: accepted first-run boundary rationale
