# Residual Frontier Quest Alignment

- Decision ID: ABYSS-STACK-D-0014
- Status: accepted
- Date: 2026-05-13
...
- Surface classes: quest/lane, validation guard
- Stack lanes: questbook
- Mechanic parents: cross-mechanic
- Guard families: questbook, validation lane
- Posture: accepted quest alignment rationale
