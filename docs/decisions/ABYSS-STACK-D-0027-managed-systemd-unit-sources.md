...
- Decision ID: ABYSS-STACK-D-0027
- Status: accepted
- Date: 2026-05-14
...
- Stack lanes: systemd units, runtime lifecycle
- Mechanic parents: runtime-lifecycle
- Guard families: systemd allowlist, source/runtime boundary
- Posture: accepted systemd source rationale
