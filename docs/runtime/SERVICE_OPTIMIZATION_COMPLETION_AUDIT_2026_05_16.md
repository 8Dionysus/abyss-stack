...
| Keep DAG engines from becoming accidental resident load | `config-templates/Configs/rag/dag-jobs.v1.json` and `docs/decisions/2026-05-16-rag-orchestration-profile.md` keep n8n, Dagster, and Temporal as explicit future/integration lanes rather than the current always-on RAG brain | done |
