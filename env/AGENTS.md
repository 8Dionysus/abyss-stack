...
- Update `docs/SECRETS_BOOTSTRAP.md` if the change affects secret bootstrap.
...
If the example set changed, re-read `docs/SECRETS_BOOTSTRAP.md` and confirm the bootstrap instructions still match.
