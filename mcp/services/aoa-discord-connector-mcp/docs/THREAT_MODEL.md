...
- Bot tokens, gateway intents, data package exports, and any linked account
  material used by Discord collection modes.
...
- Treating public-channel evidence and bot/account-visible evidence as the same
  permission class.
...
- Optional loopback HTTP requires the exact Discord read credential, scope,
