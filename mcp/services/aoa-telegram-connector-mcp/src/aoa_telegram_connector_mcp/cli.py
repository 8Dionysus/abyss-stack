"""CLI wrapper for the Telegram connector MCP service."""
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(prog="aoa-telegram-connector-mcp")
...
def _state(args: argparse.Namespace) -> AoATelegramConnectorMCPState:
    discovered = AoATelegramConnectorMCPState.discover()
