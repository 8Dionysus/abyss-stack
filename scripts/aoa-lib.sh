...
AOA_RESOURCE_ADMISSION_DIR="${AOA_RESOURCE_ADMISSION_DIR:-/run/user/${AOA_RUNTIME_UID}/abyss-machine/resource}"
...
AOA_KAG_ARTIFACT_ROOT="${AOA_KAG_ARTIFACT_ROOT:-}"
...
export AOA_RESOURCE_ADMISSION_DIR
