...
AOA_ROUTING_ROOT="${AOA_ROUTING_ROOT:-/srv/aoa-routing}"
AOA_MEMO_ROOT="${AOA_MEMO_ROOT:-/srv/aoa-memo}"
AOA_EVALS_ROOT="${AOA_EVALS_ROOT:-/srv/aoa-evals}"
AOA_PLAYBOOKS_ROOT="${AOA_PLAYBOOKS_ROOT:-/srv/aoa-playbooks}"
AOA_KAG_ROOT="${AOA_KAG_ROOT:-/srv/aoa-kag}"
AOA_TOS_ROOT="${AOA_TOS_ROOT:-/srv/Tree-of-Sophia}"
AOA_OLLAMA_WARMUP_ENABLED="${AOA_OLLAMA_WARMUP_ENABLED:-true}"
