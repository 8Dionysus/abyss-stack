...
REQUIRED_FILES = {
    ...
    ROOT / "MCP" / "AGENTS.md",
    ROOT / "MCP" / "README.md",
    ROOT / "MCP" / "aoa-memo-mcp" / "AGENTS.md",
    ROOT / "MCP" / "aoa-memo-mcp" / "README.md",
    ROOT / "MCP" / "aoa-memo-mcp" / "DESIGN.md",
    ROOT / "MCP" / "aoa-memo-mcp" / "docs" / "BOUNDARIES.md",
    ROOT / "MCP" / "aoa-memo-mcp" / "docs" / "THREAT_MODEL.md",
    ROOT / "MCP" / "aoa-memo-mcp" / "src" / "aoa_memo_mcp" / "core.py",
    ROOT / "MCP" / "aoa-memo-mcp" / "src" / "aoa_memo_mcp" / "server.py",
    ROOT / "MCP" / "aoa-memo-mcp" / "scripts" / "validate_memo_mcp.py",
    ROOT / "memo" / "AGENTS.md",
    ROOT / "memo" / "README.md",
