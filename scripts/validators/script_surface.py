...
OPERATOR_BACKEND_SCRIPTS = {
    ...
    "aoa-external-actor-bind": "mechanics/governed-execution/parts/external-codex-agent/bind_external_actor_launch.py",
    "aoa-external-codex-stasis": "mechanics/governed-execution/parts/external-codex-agent/external_codex_responsibility_movement.py",
    ...
    "aoa-deploy-owner-package": "mechanics/runtime-lifecycle/parts/deployment-route/aoa_deploy_owner_package.py",
