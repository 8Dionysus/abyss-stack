...
FEDERATION_REQUIRED_RUNTIME_INPUTS = {
    Path("config-templates") / "Configs" / "federation" / "aoa-agents.yaml": {
    ...
    Path("config-templates") / "Configs" / "federation" / "aoa-routing.yaml": {
    ...
    Path("config-templates") / "Configs" / "federation" / "aoa-memo.yaml": {
        ...
        "examples/recall/recall_contract.object.working.json",
    ...
    Path("config-templates") / "Configs" / "federation" / "aoa-kag.yaml": {
    ...
    Path("config-templates") / "Configs" / "federation" / "tos-source.yaml": {
