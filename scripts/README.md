...
| Repository validation | `validate_stack.py`, `validate_nested_agents.py`, `validate_decision_records.py`, `release_check.py` | root `AGENTS.md`, [mechanics artifact topology](../mechanics/ARTIFACT_TOPOLOGY.md), [decision records](../docs/decisions/README.md) |
