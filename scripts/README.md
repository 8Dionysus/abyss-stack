...
| Governed execution | `aoa-governed-run`, `aoa-agent-os-runtime`, `aoa-external-actor-bind`, `aoa-external-codex-agent`, `aoa-external-codex-incarnation`, `aoa-export-memo-candidate`, `aoa-export-runtime-evidence-selection`, `aoa-export-artifact-hook-candidate`, `aoa-run-memo-contradiction-integrity` | [governed execution](../mechanics/governed-execution/README.md); command backends under governed-execution and runtime-repair parts |
