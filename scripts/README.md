...
| Federation, KAG, and RPG seams | `aoa-federated-check`, `aoa-sync-federation-surfaces`, `aoa-routing-canary`, `aoa-kag-runtime-family`, `aoa-kag-runtime-projection`, `aoa-kag-runtime-eval`, `tos-up`, `aoa-tos-graph`, `aoa-rpg-runtime-projection` | [federation seams](../mechanics/federation-seams/README.md); command backends under `mechanics/federation-seams/parts/` |
