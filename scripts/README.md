...
| Owner-source deployment | `aoa-deploy-owner-package` | [runtime lifecycle deployment route](../mechanics/runtime-lifecycle/parts/deployment-route/README.md); implementation under `mechanics/runtime-lifecycle/parts/deployment-route/` |
