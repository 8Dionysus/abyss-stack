...
| Codex hooks | `parts/codex-hooks/` | owner/native hook fragments, stack-owned Codex `PreToolUse` agent-routing adapter, context schema, `parts/codex-hooks/scripts/render_codex_hooks.py`, fragment and composition-receipt schemas, focused composition and routing tests |
