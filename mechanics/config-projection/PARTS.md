...
| Codex hooks | `parts/codex-hooks/` | owner/native hook fragments, stack-owned Codex `PreToolUse` context relay and agent-routing adapter, clean-source content-addressed installer, context schema, renderer, fragment and composition-receipt schemas, focused composition/routing/install tests |
