...
| Host facts | `parts/host-facts/` | `scripts/aoa-host-facts`, `mechanics/diagnostic-spine/parts/doctor-readiness/docs/DOCTOR.md`, host-facts schema and public examples |
