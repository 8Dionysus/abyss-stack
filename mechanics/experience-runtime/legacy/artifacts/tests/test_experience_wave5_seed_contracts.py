...
WAVE5_CONTRACTS = (
    ('console_queue_worker_v1', 'console_queue_worker_v1.json'),
    ('handoff_graph_worker_v1', 'handoff_graph_worker_v1.json'),
    ('office_mesh_storage_record_v1', 'office_mesh_storage_record_v1.json'),
    ('office_release_train_worker_v1', 'office_release_train_worker_v1.json'),
    ('release_lifecycle_worker_v1', 'release_lifecycle_worker_v1.json'),
    ('runtime_storage_migration_v1', 'runtime_storage_migration_v1.json'),
    ('service_mesh_watch_worker_v1', 'service_mesh_watch_worker_v1.json'),
    ('smoke_test_worker_v1', 'smoke_test_worker_v1.json'),
)
