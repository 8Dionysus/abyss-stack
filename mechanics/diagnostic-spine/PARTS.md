...
|---|---|---|
| Doctor readiness | `parts/doctor-readiness/` | `scripts/aoa-doctor`, `mechanics/diagnostic-spine/parts/doctor-readiness/docs/DOCTOR.md`, `mechanics/diagnostic-spine/parts/doctor-readiness/docs/LOCAL_OPS_DOCTOR_SPLIT.md` |
...
| Diagnostic surfaces | `parts/diagnostic-surfaces/` | `mechanics/diagnostic-spine/parts/diagnostic-surfaces/docs/DIAGNOSTIC_SPINE.md`, schemas, examples, generated catalog, and package-local tests under `mechanics/diagnostic-spine/parts/diagnostic-surfaces/` |
