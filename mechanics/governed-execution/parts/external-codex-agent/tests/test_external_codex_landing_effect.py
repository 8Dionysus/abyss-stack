...
def _legacy_workspace_manifest_owner_receipt_raw(
...
def _legacy_workspace_manifest_evidence_raw(
    grant: dict[str, Any], manifest_digest: str, owner_receipt_digest: str
) -> bytes:
    return (
        json.dumps(
            {
