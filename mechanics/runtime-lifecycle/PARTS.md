...
| Owner-source deployment route | `parts/deployment-route/` | `scripts/aoa-deploy-owner-package`, `parts/deployment-route/aoa_deploy_owner_package.py`, typed admission/prepare/activate/rollback receipts, durable activation-recovery journal schema, and focused disposable-route tests |
