...
| Owner-source deployment route | `parts/deployment-route/` | `scripts/aoa-deploy-owner-package`, `parts/deployment-route/aoa_deploy_owner_package.py`, typed admission and prepare/activate/rollback receipt schemas, and focused disposable-route tests |
