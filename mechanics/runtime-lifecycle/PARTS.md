...
| Config sync boundary | `parts/config-sync-boundary/` | `scripts/aoa-sync-configs`, `docs/DEPLOYMENT.md`, `mechanics/runtime-lifecycle/parts/config-sync-boundary/docs/SOURCE_RUNTIME_PARITY_PACKET.md` |
| Start and stop | `parts/start-stop/` | `scripts/aoa-up`, `scripts/aoa-down`, `scripts/aoa-warmup`, `parts/start-stop/aoa_up.sh`, `parts/start-stop/aoa_down.sh`, `parts/start-stop/aoa_warmup.sh`, `mechanics/runtime-lifecycle/parts/start-stop/docs/LIVE_RUNTIME_CUTOVER_PACKET.md`, `compose/profiles/`, `compose/presets/` |
