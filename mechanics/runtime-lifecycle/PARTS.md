...
| Wait and smoke | `parts/wait-smoke/` | `scripts/aoa-wait`, `scripts/aoa-smoke`, `parts/wait-smoke/aoa_wait.sh`, `parts/wait-smoke/aoa_smoke.sh`, `mechanics/runtime-lifecycle/parts/wait-smoke/docs/INTERNAL_PROBES.md` |
