...
if ((selection_metadata_ready)) && has_module "43-federation-router.yml"; then
  ...
  check_warn_file "aoa-memo memory model doc" "${AOA_STACK_ROOT}/Knowledge/federation/aoa-memo/docs/MEMORY_MODEL.md"
  check_warn_file "aoa-memo runtime writeback seam doc" "${AOA_STACK_ROOT}/Knowledge/federation/aoa-memo/docs/RUNTIME_WRITEBACK_SEAM.md"
  check_warn_file "aoa-memo recurrence support doc" "${AOA_STACK_ROOT}/Knowledge/federation/aoa-memo/docs/RECURRENCE_MEMORY_SUPPORT_SURFACES.md"
  check_warn_file "aoa-memo agent posture seam doc" "${AOA_STACK_ROOT}/Knowledge/federation/aoa-memo/docs/AGENT_MEMORY_POSTURE_SEAM.md"
  check_warn_file "aoa-memo playbook scopes doc" "${AOA_STACK_ROOT}/Knowledge/federation/aoa-memo/docs/PLAYBOOK_MEMORY_SCOPES.md"
  check_warn_file "aoa-memo registry" "${AOA_STACK_ROOT}/Knowledge/federation/aoa-memo/generated/memo_registry.min.json"
  check_warn_file "aoa-memo catalog" "${AOA_STACK_ROOT}/Knowledge/federation/aoa-memo/generated/memory_catalog.min.json"
  check_warn_file "aoa-memo sections" "${AOA_STACK_ROOT}/Knowledge/federation/aoa-memo/generated/memory_sections.full.json"
  check_warn_file "aoa-memo object catalog" "${AOA_STACK_ROOT}/Knowledge/federation/aoa-memo/generated/memory_object_catalog.min.json"
  check_warn_file "aoa-memo object sections" "${AOA_STACK_ROOT}/Knowledge/federation/aoa-memo/generated/memory_object_sections.full.json"
  check_file "aoa-memo runtime writeback targets" "${AOA_STACK_ROOT}/Knowledge/federation/aoa-memo/generated/runtime_writeback_targets.min.json"
  check_file "aoa-memo runtime writeback intake" "${AOA_STACK_ROOT}/Knowledge/federation/aoa-memo/generated/runtime_writeback_intake.min.json"
  check_warn_file "aoa-memo checkpoint contract example" "${AOA_STACK_ROOT}/Knowledge/federation/aoa-memo/examples/checkpoint_to_memory_contract.example.json"
  check_warn_file "aoa-memo router semantic recall contract" "${AOA_STACK_ROOT}/Knowledge/federation/aoa-memo/examples/recall_contract.router.semantic.json"
  check_warn_file "aoa-memo router lineage recall contract" "${AOA_STACK_ROOT}/Knowledge/federation/aoa-memo/examples/recall_contract.router.lineage.json"
  check_warn_file "aoa-memo object working recall contract" "${AOA_STACK_ROOT}/Knowledge/federation/aoa-memo/examples/recall_contract.object.working.json"
  check_warn_file "aoa-memo object semantic recall contract" "${AOA_STACK_ROOT}/Knowledge/federation/aoa-memo/examples/recall_contract.object.semantic.json"
  check_warn_file "aoa-memo object lineage recall contract" "${AOA_STACK_ROOT}/Knowledge/federation/aoa-memo/examples/recall_contract.object.lineage.json"
  check_warn_file "aoa-memo object return-ready recall contract" "${AOA_STACK_ROOT}/Knowledge/federation/aoa-memo/examples/recall_contract.object.working.return.json"
  check_warn_file "aoa-memo checkpoint schema" "${AOA_STACK_ROOT}/Knowledge/federation/aoa-memo/schemas/checkpoint-to-memory-contract.schema.json"
  check_warn_file "aoa-memo core contract schema" "${AOA_STACK_ROOT}/Knowledge/federation/aoa-memo/schemas/core-memory-contract.schema.json"
  ...
  check_file "aoa-evals phase alpha memo recall evidence template" "${AOA_STACK_ROOT}/Knowledge/federation/aoa-evals/examples/runtime_evidence_selection.phase-alpha-memo-recall-rerun.example.json"
  check_file "aoa-evals phase alpha memo contradiction gap evidence template" "${AOA_STACK_ROOT}/Knowledge/federation/aoa-evals/examples/runtime_evidence_selection.phase-alpha-memo-contradiction-gap.example.json"
  check_file "aoa-evals phase alpha memo contradiction rerun evidence template" "${AOA_STACK_ROOT}/Knowledge/federation/aoa-evals/examples/runtime_evidence_selection.phase-alpha-memo-contradiction-rerun.example.json"
  ...
  check_warn_file "aoa-playbooks execution seam doc" "${AOA_STACK_ROOT}/Knowledge/federation/aoa-playbooks/docs/PLAYBOOK_EXECUTION_SEAM.md"
  check_warn_file "aoa-playbooks model doc" "${AOA_STACK_ROOT}/Knowledge/federation/aoa-playbooks/docs/PLAYBOOK_MODEL.md"
  check_warn_file "aoa-playbooks lifecycle doc" "${AOA_STACK_ROOT}/Knowledge/federation/aoa-playbooks/docs/PLAYBOOK_LIFECYCLE.md"
  check_warn_file "aoa-playbooks recurrence discipline doc" "${AOA_STACK_ROOT}/Knowledge/federation/aoa-playbooks/docs/PLAYBOOK_RECURRENCE_DISCIPLINE.md"
  check_warn_file "aoa-playbooks registry" "${AOA_STACK_ROOT}/Knowledge/federation/aoa-playbooks/generated/playbook_registry.min.json"
  check_warn_file "aoa-playbooks activation" "${AOA_STACK_ROOT}/Knowledge/federation/aoa-playbooks/generated/playbook_activation_surfaces.min.json"
  check_warn_file "aoa-playbooks federation" "${AOA_STACK_ROOT}/Knowledge/federation/aoa-playbooks/generated/playbook_federation_surfaces.min.json"
  check_warn_file "aoa-playbooks review status" "${AOA_STACK_ROOT}/Knowledge/federation/aoa-playbooks/generated/playbook_review_status.min.json"
  ...
  check_warn_file "aoa-playbooks automation seeds" "${AOA_STACK_ROOT}/Knowledge/federation/aoa-playbooks/generated/playbook_automation_seeds.json"
  ...
  check_warn_file "aoa-playbooks federation schema" "${AOA_STACK_ROOT}/Knowledge/federation/aoa-playbooks/schemas/playbook-federation-surface.schema.json"
  check_warn_file "aoa-playbooks review-status schema" "${AOA_STACK_ROOT}/Knowledge/federation/aoa-playbooks/schemas/playbook-review-status.schema.json"
  check_warn_file "aoa-playbooks long-horizon activation example" "${AOA_STACK_ROOT}/Knowledge/federation/aoa-playbooks/examples/playbook_activation.long-horizon-model-tier-orchestra.example.json"
  check_warn_file "aoa-playbooks restartable activation example" "${AOA_STACK_ROOT}/Knowledge/federation/aoa-playbooks/examples/playbook_activation.restartable-inquiry-loop.example.json"
  check_warn_file "aoa-playbooks cross-repo activation example" "${AOA_STACK_ROOT}/Knowledge/federation/aoa-playbooks/examples/playbook_activation.cross-repo-boundary-rollout.example.json"
