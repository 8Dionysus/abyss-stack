...
allowing the current read/bootstrap processes to remain active. Only after that
gate succeeds does admission stop the exact read and bootstrap fleet so their
