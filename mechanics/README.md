...
| [runtime-repair](runtime-repair/README.md) | How do degradation receipts, repair-safe closeout, A2A return, and antifragility stay bounded? | `mechanics/runtime-repair/docs/ANTIFRAGILITY_RUNTIME.md`, `mechanics/runtime-repair/docs/REPAIR_SAFE_CLOSEOUT.md`, `mechanics/runtime-repair/PROVENANCE.md` |
