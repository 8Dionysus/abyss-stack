...
- runs the preserved runtime compatibility gate on `http://127.0.0.1:5403/run` under `qwen-llamacpp-pilot-v1` using the preserved trial runtime gate ID
- runs one disposable edit fixture compatibility gate under `langgraph-sidecar-llamacpp-v1` using the preserved trial edit gate ID
