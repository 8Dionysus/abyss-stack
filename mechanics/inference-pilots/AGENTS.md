...
compatibility runners belong under `legacy/artifacts/scripts/` and should be
reached through thin part-local bridges.
...
python -m py_compile mechanics/inference-pilots/legacy/artifacts/scripts/aoa-local-ai-trials mechanics/inference-pilots/legacy/artifacts/scripts/aoa-w5-pilot mechanics/inference-pilots/legacy/artifacts/scripts/aoa-w6-pilot
```
