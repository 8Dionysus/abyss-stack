...
|---|---|---|
| llama.cpp pilot | `parts/llamacpp-pilot/` | `mechanics/inference-pilots/docs/LLAMACPP_PILOT.md`, `scripts/aoa-llamacpp-pilot`, `compose/modules/32-llamacpp-inference.yml` |
