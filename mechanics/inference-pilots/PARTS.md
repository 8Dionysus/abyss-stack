...
| Pilot archive bridge | `parts/pilot-archive-bridge/` | `PROVENANCE.md`, `legacy/INDEX.md`, `legacy/DISTILLATION_LOG.md`, `legacy/artifacts/scripts/` |
