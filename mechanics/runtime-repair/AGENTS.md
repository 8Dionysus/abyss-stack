...
`PARTS.md` before editing. Use `PROVENANCE.md` and `legacy/INDEX.md` before
editing moved receipt artifacts.
...
python -m pytest mechanics/runtime-repair/legacy/artifacts/tests tests/test_a2a_return_closeout_dry_run.py tests/test_memo_contradiction_integrity_runner.py
